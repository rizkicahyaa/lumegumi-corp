        ...
        <section id="games" className="section-texture w-full bg-[#111111] relative py-20 px-6 lg:px-16 overflow-hidden" aria-labelledby="games-heading">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {games.map((game) => (
                        <Link key={game.id} href={`/games/${game.slug}`} id={`game-card-${game.slug}`} data-aos="fade-up" data-aos-delay={game.delay} className="group relative flex flex-col bg-[#111111] border border-white/8 hover:border-white/20 hover:bg-[#1c1c1c] transition-colors duration-300 cursor-pointer overflow-hidden">
